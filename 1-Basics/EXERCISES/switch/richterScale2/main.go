...
func main() {
	...
	switch v := value; {
	case v == "micro":
		description = "%s's richter scale is less than 2.0.\n"
	case v == "very minor":
		description = "%s's richter scale is 2.0 - 2.9.\n"
	case v == "minor":
		description = "%s's richter scale is 3.0 - 3.9.\n"
	case v == "light":
		description = "%s's richter scale is 4.0 - 4.9.\n"
	case v == "moderate":
		description = "%s's richter scale is 5.0 - 5.9.\n"
	case v == "strong":
		description = "%s's richter scale is 6.0 - 6.9.\n"
	case v == "major":
		description = "%s's richter scale is 7.0 - 7.9.\n"
	case v == "great":
		description = "%s's richter scale is 8.0 - 9.9.\n"
	case v == "massive":
		description = "%s's richter scale is 10+.\n"
	default:
		description = "%s''s richter scale is unknown..\n"
	}

	fmt.Printf(description, value)
}
